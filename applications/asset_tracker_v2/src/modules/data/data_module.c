...
static void on_cloud_state_disconnected(struct module_msg *msg)
{
...
static void on_cloud_state_connected(struct module_msg *msg)
{
...
static void on_all_states(struct module_msg *msg)
{
	...
	if (IS_MSG(msg, APP_MSG_DATA_GET)) {
		 ...
		 */
		requested_data_list_set(msg->app.data_list,
					msg->app.count);
